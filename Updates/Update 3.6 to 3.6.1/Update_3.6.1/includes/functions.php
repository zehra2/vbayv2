...
function ffmpeg_convert($post_id, $post_author_id, $video_name, $thumbnail = '')
{
  ...
  if (!$thumbnail) {
    ...
    if (!file_exists($thumbnail_path)) {
      ...
      save_file_to_cloud($path, $thumbnail_name);
  ...
  $video_240p_name = $videos_directory . $original_hash . '_240p.mp4';
  ...
  if (!file_exists($video_240_local_path) && $resolution >= 426) {
    ...
    save_file_to_cloud($video_240_local_path, $videos_directory . $system['uploads_prefix'] . '_' . $original_hash . '_240p.mp4');
    /* update video */
  ...
  $video_360p_name = $videos_directory . $original_hash . '_360p.mp4';
  ...
  if (!file_exists($video_360_local_path) && $resolution >= 640) {
    ...
    /* save the new video to cloud */
    save_file_to_cloud($video_360_local_path, $videos_directory . $system['uploads_prefix'] . '_' . $original_hash . '_360p.mp4');
    /* update video */
  ...
  $video_480p_name = $videos_directory . $original_hash . '_480p.mp4';
  ...
  if (!file_exists($video_480_local_path) && $resolution >= 854) {
    ...
    /* save the new video to cloud */
    save_file_to_cloud($video_480_local_path, $videos_directory . $system['uploads_prefix'] . '_' . $original_hash . '_480p.mp4');
    /* update video */
  ...
  $video_720p_name = $videos_directory . $original_hash . '_720p.mp4';
  ...
  if (!file_exists($video_720_local_path) && $resolution >= 1280) {
    ...
    /* save the new video to cloud */
    save_file_to_cloud($video_720_local_path, $videos_directory . $system['uploads_prefix'] . '_' . $original_hash . '_720p.mp4');
    /* update video */
  ...
  $video_1080p_name = $videos_directory . $original_hash . '_1080p.mp4';
  ...
  if (!file_exists($video_1080_local_path) && $resolution >= 1920) {
    ...
    /* save the new video to cloud */
    save_file_to_cloud($video_1080_local_path, $videos_directory . $system['uploads_prefix'] . '_' . $original_hash . '_1080p.mp4');
    /* update video */
  ...
  $video_1440p_name = $videos_directory . $original_hash . '_1440p.mp4';
  ...
  if (!file_exists($video_1440_local_path) && $resolution >= 2048) {
    ...
    /* save the new video to cloud */
    save_file_to_cloud($video_1440_local_path, $videos_directory . $system['uploads_prefix'] . '_' . $original_hash . '_1440p.mp4');
    /* update video */
  ...
  $video_2160p_name = $videos_directory . $original_hash . '_2160p.mp4';
  ...
  if (!file_exists($video_2160_local_path) && $resolution >= 3840) {
    ...
    /* save the new video to cloud */
    save_file_to_cloud($video_2160_local_path, $videos_directory . $system['uploads_prefix'] . '_' . $original_hash . '_2160p.mp4');
    /* update video */
